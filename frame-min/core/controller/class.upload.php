...
if (!empty($_POST)) {
	if(isset($_POST["title"]) && isset($_POST["content"])){
		...
		header("Location: ./?view=Note/notes");
	}
}
?>
----------------------------------------
...
if(isset($_GET["id"])){
	...
	print "<script>window.location= './?view=Note/notes';</script>";
}
...
<div class="row">
	<div class="col-md-12">
<a href="./?view=Note/newnote" class="btn btn-default pull-right">Nueva Nota</a>
		<h1>Notas</h1>
		<?php $notes = NoteData::getAll(); ?>
...
<?php if (count($notes)>0): ?>
	<table class="table table-bordered table-hover">
		...
		<?php  foreach($notes as $note):?>
		    <tr>
		    <td>
		    	<a href="./?view=Note/opennote&id=<?php echo $note->id ?>" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
		    </td>
			<td><?php echo $note->title; ?></td>
			<td><?php echo $note->content; ?></td>
			<td><?php echo $note->created_at; ?></td>
			<td>
				<a href="./?view=note/editnote&id=<?php echo $note->id ?>" class="btn btn-default btn-warning"><i class="fa fa-edit"></i></a>
				<a href="./?action=delnote&id=<?php echo $note->id ?>" class="btn btn-default btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
			</td>
		    </tr>
	<?php endforeach ?>
	</table>
...
<?php else:?>
	<p class="alert alert-warning">No hay notas</p>
<?php endif;?>
</div>
</div>
</div>
...
<div class="col-md-12">
	...
	<form method="Post" action="./?action=addnote">
	<label for="title">Titulo</label>
	<input type="text" name="title" id="title" required class="form-control" placeholder="Escribe el titulo">
	<label for="content">Contenido</label>
	<textarea name="content" id="content" required class="form-control" placeholder="Escribe el contenido"></textarea>
...
<?php $note = NoteData::getById($_GET["id"]); ?>
<?php if($note!=null): ?>	
...
<div class="col-md-12">
	...
	<form method="Post" action="./?action=updatenote">
		<input type="hidden" name="id" value="<?php echo $note->id; ?>">
	<label for="title">Titulo</label>
	<input type="text" name="title" id="title" value="<?php echo $note->title; ?>" required class="form-control" placeholder="Escribe el titulo">
	<label for="content">Contenido</label>
	<textarea name="content" id="content" required class="form-control" placeholder="Escribe el contenido"><?php echo $note->content; ?></textarea>
...
<?php else: ?>
	<p class="alert alert-danger">Nota no existe!</p>
<?php endif;?>	

<?php else: ?>
	<p class="alert alert-danger">Nota no hay ID!</p>
<?php endif;?>	
...
<?php if($note!=null):?>
	...
	<p class="text-muted"><?php echo $note->created_at; ?></p>
	</div>
	</div>
